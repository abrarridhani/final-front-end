            ...
            @forelse ($newWorkshops as $itemNewWorkshop)
                    <a href="{{ route('front.details', $itemNewWorkshop->slug) }}" class="card">
                        <div class="flex flex-col h-full justify-between rounded-3xl p-6 gap-9 bg-white">
                            <a class="flex flex-col gap-[18px]">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="flex flex-col gap-[2px]">
                                        ...
                                        <p class="font-medium text-aktiv-grey">{{ $itemNewWorkshop->instructor->occupation }}
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="thumbnail-container relative h-[200px] rounded-xl bg-[#D9D9D9] overflow-hidden">
                                    ...
                                    @if ($itemNewWorkshop->is_open)
                                        @if ($itemNewWorkshop->has_started)
                                            <div
                                                class="absolute top-3 left-3 flex items-center rounded-full py-3 px-5 gap-1 bg-aktiv-orange">
            ...
            <div class="flex flex-col h-full justify-between rounded-3xl p-6 gap-9 bg-white">
                <div class="flex flex-col gap-[18px]">
                    ...
                    <div class="card-detail flex flex-col gap-2">
                        ...
                        <h3 class="title min-h-[56px] font-semibold text-xl line-clamp-2 hover:line-clamp-none">
                            Mastering the Art of Public Speaking: Practical Tips and Powerful Techniques</h3>
        ...
        <a href="details-started.html" class="card">
            <div class="flex flex-col h-full justify-between rounded-3xl p-6 gap-9 bg-white">
                <div class="flex flex-col gap-[18px]">
                    <div class="flex items-center gap-3">
                        <div class="w-16 h-16 rounded-full flex shrink-0 overflow-hidden">
                            <img src="{{asset('assets/images/photos/photo2.png')}}" class="w-full h-full object-cover"
                                alt="avatar">
                        </div>
                        <div class="flex flex-col gap-[2px]">
        ...
        <a href="details-closed.html" class="card">
            <div class="flex flex-col h-full justify-between rounded-3xl p-6 gap-9 bg-white">
                <div class="flex flex-col gap-[18px]">
                    <div class="flex items-center gap-3">
                        <div class="w-16 h-16 rounded-full flex shrink-0 overflow-hidden">
                            <img src="{{asset('assets/images/photos/photo3.png')}}" class="w-full h-full object-cover"
                                alt="avatar">
                        </div>
                        <div class="flex flex-col gap-[2px]">
                    ...
                    <div class="card-detail flex flex-col gap-2">
                        ...
                        <h3 class="title min-h-[56px] font-semibold text-xl line-clamp-2 hover:line-clamp-none">UX/UI
                            Design: Creating Amazing User Experiences</h3>
        ...
        <a href="details.html" class="card">
            <div class="flex flex-col h-full justify-between rounded-3xl p-6 gap-9 bg-white">
                <div class="flex flex-col gap-[18px]">
                    <div class="flex items-center gap-3">
                        <div class="w-16 h-16 rounded-full flex shrink-0 overflow-hidden">
                            <img src="{{asset('assets/images/photos/photo4.png')}}" class="w-full h-full object-cover"
                                alt="avatar">
                        </div>
                        <div class="flex flex-col gap-[2px]">
        ...
        <a href="details.html" class="card">
            <div class="flex flex-col h-full justify-between rounded-3xl p-6 gap-9 bg-white">
                <div class="flex flex-col gap-[18px]">
                    <div class="flex items-center gap-3">
                        <div class="w-16 h-16 rounded-full flex shrink-0 overflow-hidden">
                            <img src="{{asset('assets/images/photos/photo5.png')}}" class="w-full h-full object-cover"
                                alt="avatar">
                        </div>
                        <div class="flex flex-col gap-[2px]">
                    ...
                    <div class="card-detail flex flex-col gap-2">
                        ...
                        <h3 class="title min-h-[56px] font-semibold text-xl line-clamp-2 hover:line-clamp-none">Building
                            Confidence and Mastering Sales Techniques: A Complete Guide for Sales Professionals to
        ...
        <a href="details.html" class="card">
            <div class="flex flex-col h-full justify-between rounded-3xl p-6 gap-9 bg-white">
                <div class="flex flex-col gap-[18px]">
                    <div class="flex items-center gap-3">
                        <div class="w-16 h-16 rounded-full flex shrink-0 overflow-hidden">
                            <img src="{{asset('assets/images/photos/photo6.png')}}" class="w-full h-full object-cover"
                                alt="avatar">
                        </div>
                        <div class="flex flex-col gap-[2px]">
                    ...
                    <div class="card-detail flex flex-col gap-2">
                        ...
                        <h3 class="title min-h-[56px] font-semibold text-xl line-clamp-2 hover:line-clamp-none">Managing
                            Stress and Mental Health in the Music Industry</h3>
                        <p class="font-medium text-aktiv-grey">Self Improvement</p>
                    </div>
                </div>
                <div class="flex items-center justify-between">
