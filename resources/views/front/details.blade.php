    ...
    <div class="flex flex-col gap-16">
        ...
        <div class="flex flex-col items-center gap-1">
            ...
            <div class="flex items-center gap-2 text-white">
                <a href="#" class="last:font-semibold">Homepage</a>
                <span>></span>
                <a href="#" class="last:font-semibold">Workshop Details</a>
            </div>
        </div>
        ...
        <main class="flex gap-8">
            <!-- Left Column -->
            <section id="Details" class="flex flex-col w-[420px] rounded-2xl gap-8 p-8 bg-white">
                ...
                <section id="Header" class="flex flex-col gap-6">
                    <div id="Rating" class="flex items-center gap-4">
                        <div
                            ...
                            <p class="font-medium text-aktiv-green capitalize">Pemrogramman</p>
                        </div>
                        <div class="flex items-center gap-1">
                            ...
                            <p class="font-semibold text-lg leading-[27px]">
                                4.5 <span class="font-medium text-aktiv-grey">(3250 Reviews)</span>
                            </p>
                        </div>
                    </div>
                            ...
                            <div
                                ...
                                <div class="flex flex-col gap-3 justify-between">
                                    ...
                                    <a href="https://www.google.com/maps/place/{{ $workshop->address }}"
                                        class="font-semibold text-aktiv-orange">
                                        View in Google Maps
                                    </a>
                                </div>
                            </div>
            ...
            <section id="sidebar" class="flex flex-col w-[420px] gap-8">
                ...
                <div class="flex flex-col rounded-3xl pt-8 gap-6 bg-white">
                    ...
                    <div
                        class="flex items-center justify-between mx-8 rounded-2xl border border-[#E6E7EB] py-4 px-6 gap-2">
                    ...
                    <div class="flex flex-col">
                        <a href="{{route('front.booking', $workshop->slug)}}"
                            class="flex items-center justify-center mx-8 h-16 rounded-xl px-6 gap-[10px] bg-aktiv-orange font-semibold text-lg leading-[27px] text-white mb-8 shadow-lg hover:bg-orange-500 transition">
                            Join Workshop
                        </a>
                    </div>
            </section>
