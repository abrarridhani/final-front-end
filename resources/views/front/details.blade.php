            ...
            <section id="Details" class="flex flex-col w-[724px] rounded-2xl gap-8 p-8 bg-white">
                ...
                <section id="Header" class="flex flex-col gap-6">
                    ...
                    <div id="Title" class="flex flex-col gap-3">
                        <h1 class="font-Neue-Plak-bold text-2xl leading-[33.6px] capitalize">Mastering the Art of Public
                            Speaking: Practical Tips and Powerful Techniques</h1>
                        <div class="grid grid-cols-2 gap-6">
                            ...
                            <div
                                ...
                                <img src="assets/images/icons/Kick off date.png" class="w-16 h-16 flex shrink-0"
                                    alt="icon">
                            </div>
                        </div>
                    </div>
                ...
                <div id="Descriptions" class="flex flex-col gap-4">
                    ...
                    <p class="group relative font-medium leading-[28.8px] text-aktiv-grey">
                        <span class="line-clamp-4 group-has-[:checked]:line-clamp-none">Unlock your potential and become
                            a confident, persuasive speaker with our comprehensive workshop, "Mastering the Art of
                            Public Speaking: Tips and Techniques." This interactive session is designed to provide
                            participants with essential skills and Lorem ipsum dolor sit amet consectetur adipisicing
                            elit. Voluptate fuga unde corporis perspiciatis culpa ipsa iusto doloremque vero, impedit,
                            similique sed odit laudantium pariatur omnis ducimus nisi, repellat dolorem eos excepturi
                            natus. Cupiditate facere expedita quasi maiores nihil error optio, doloribus, voluptate et
                            numquam voluptates repudiandae tempora velit. Fugiat, voluptatem.</span>
                    ...
                    <div class="relative flex w-full h-[360px] rounded-2xl overflow-hidden bg-[#D9D9D9]">
                        <div
                            ...
                            <div class="flex w-full h-[124px] rounded-xl overflow-hidden">
                                <img src="assets/images/thumbnails/location.png" class="w-full h-full object-cover"
                                    alt="location">
                            </div>
                            <div class="flex flex-col gap-3 justify-between">
                                <p class="font-medium leading-[25.6px] text-aktiv-grey line-clamp-4">101 Cendrawasih
                                    Road, Melati, Bandung Wetan, Bandung, West Java, 40116, Indonesia</p>
